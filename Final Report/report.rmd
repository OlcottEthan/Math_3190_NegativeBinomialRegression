...
This is important because in regression, when using the Negative binomial distribution we are able to account for the mean and the variance being different thus allowing it to be applied in more cases.

<br>
Now see that we have the regressive model for the Negative Binomial:
