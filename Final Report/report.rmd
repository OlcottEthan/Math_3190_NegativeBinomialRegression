...
&=y_i x_1-\frac{\alpha x_1 e^{x_i\cdot\boldsymbol\beta}(y_i+1/\alpha)}{1+\alpha e^{\mathrm x_i\cdot\boldsymbol\beta}}\\
&\ \vdots\\
\frac{\partial\ell(\alpha,\boldsymbol\beta)}{\partial\beta_p}
&=y_i x_p-\frac{\alpha x_p e^{x_i\cdot\boldsymbol\beta}(y_i+1/\alpha)}{1+\alpha e^{\mathrm x_i\cdot\boldsymbol\beta}}
\end{align*}
...
In R we can do this with the `confint` function.
